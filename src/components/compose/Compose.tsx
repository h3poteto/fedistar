...
const Compose: React.FC<Props> = props => {
  ...
  return (
    <Container style={{ backgroundColor: 'var(--rs-divider-border)', height: '100%', overflowY: 'auto' }}>
      ...
      <Content style={{ height: '100%', margin: '12px', backgroundColor: 'var(--rs-divider-border)' }}>
